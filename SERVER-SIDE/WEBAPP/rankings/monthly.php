...
SELECT TOP 25 CharInfo.cid, CharInfo.Name, CharInfo.Class, CharInfo.Race, CharInfo.Level, CharInfo.MFame, CharInfoEx.cid, CharInfoEx.ServerID, ISNULL(TblGuildInfo.strGuildName, '-') AS strGuildName,
...
while ($row = odbc_fetch_array($stmt)) {
	...
	if ($row['MFame'] >= 1000) {
   	$row['MFame'] = floor($row['MFame']);
	}
	$formatted_fame = number_format($row['MFame']);
