...
$(function() {
	$('.side_menu_a').each(function(index) {
		...
		if (idx == 4) {
			$(this).children('div').css('background-image', "url('/Page/img/side/sidebox-3.gif')");
		}
		else {
			$(this).children('div').css('background-image', "url('/Page/img/side/sidebox-2.gif')");
			$(this).on({
				mouseover: function() {
					$(this).css('color', '#646464');
					$(this).children('div').css('background-image', "url('/Page/img/side/sidebox-3.gif')");
...
var rsaPublicKeyModulus = "";
...
<div id="side_menu" align="center" class="zero_margin zero_padding" style="width:174px;">
	<img src="/Page/en/img/side/05_06/sidebox-1-05.gif" class="img-responsive" />
	<!-- <a href="page1.jsp" class="side_menu_a"><img src="/Page/img/side/07_item mall/sidebox-2-1.gif" class="img-responsive" /></a> -->
	<a href="/Page/en/forum/forum.jsp?p=1&bbs=0" class="side_menu_a"><div>Latest News</div></a>
	<a href="/Page/en/forum/forum.jsp?p=1&bbs=1" class="side_menu_a"><div>Update News</div></a>
	<!--<a href="/Page/en/forum/forum.jsp?p=1&bbs=2" class="side_menu_a"><div>General Discussion</div></a>-->
	<!--<a href="/Page/en/forum/forum.jsp?p=1&bbs=3" class="side_menu_a"><div>Trade</div></a>-->
	<!--<a href="/Page/en/forum/forum.jsp?p=1&bbs=8" class="side_menu_a"><div>GUILD</div></a>-->
	<a href="/Page/en/forum/forum.jsp?p=1&bbs=4" class="side_menu_a"><div>Tip and Tech</div></a>
	<!--<a href="/Page/en/forum/forum.jsp?p=1&bbs=5" class="side_menu_a"><div>Bug Reports</div></a>-->
	<!--<a href="/Page/en/forum/forum.jsp?p=1&bbs=6" class="side_menu_a"><div>Screenshots</div></a>-->
	<a href="/Page/en/forum/forum.jsp?p=1&bbs=7" class="side_menu_a"><div>FAQ</div></a>
...
<style type="text/css">
	...
	@import url("/Page/css/lay_community.css");
