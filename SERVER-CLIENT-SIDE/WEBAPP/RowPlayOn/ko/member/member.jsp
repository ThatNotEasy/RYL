...
var rsaPublicKeyModulus = "";
...
<script type="text/javascript" src="/Page/js/common3.js"></script>

<div id="main_content">
	<img src="/Page/ko/img/sub/member/member_02.gif" class="img-responsive" />
	...
	<div style="border:thin solid #e8e8e8; background-color:#ffffff; padding:15px 15px 15px 15px; margin:5px 0 5px 0;">
		...
		<img src="/Page/ko/img/sub/member/contents_img_04.gif" class="img-responsive"><br>
	
		<div align="left" style="margin-bottom:10px; color:#646464;">
			<b style="font-size: 14pt;">Terms of Use</b>
		</div>
		<div style="width:100%; padding:5px 0px 15px 0px;">
		<!-- Terms of use Area Begin -->
		...
		<iframe src="/Page/member/agree.html" style="width:100%;" height="200;" name="terms_of_use" frameborder="0" scrolling="auto"></iframe>
		</div>
		<!-- Terms of use Area End -->
		</div>
	
		<div align="left" style="margin-bottom:10px; color:#646464;">
			<b style="font-size: 14pt;">Privacy Policy</b>
		</div>
		<div style="width:100%; padding:5px 0px 5px 0px;">
		<!-- Privacy Policy Area Begin -->
		<div style="padding:7px 7px 7px 7px; border-radius:5px; border-width: thin; border-style: solid; border-color: #e0e0e0; font-size: 10pt; color:#000000;">
		<iframe src="/Page/member/privacy.html" style="width:100%;" height="200;" name="privacy_policy" frameborder="0" scrolling="auto"></iframe>
		<!-- Privacy Policy Area End -->
		</div>
	
		<div style="width:100%;" align="center">
		In order to proceed, you must agree with our terms by clicking the "Agree" button.
		<div style="padding:10px 0px 0px 0px;" align="center">
		<a href="/Page/en/member/member.jsp?p=2"><img src="/Page/ko/img/sub/member/btn2_agree.gif"></a> &nbsp;&nbsp;
		<a href="JavaScript:history.back(-1)"><img src="/Page/ko/img/sub/member/btn2_cancel2.gif"></a>				
		</div>
		</div>
		</div>
		</div>
