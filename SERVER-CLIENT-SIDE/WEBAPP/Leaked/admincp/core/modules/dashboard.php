...
function dashboard_invoke()
{
    ...
    // -----------------
    echoheader('-@dashboard/style.css', "Dashboard");
...
function dashboard_sysconf()
{
    ...
    $options_list = array(
        ...
        'general' => array(
            ...
            'http_script_dir'       => array('text', 'Full URL to News directory|example: http://yoursite.com/news'),
            'main_site'             => array('text', 'URL to your site|example: http://yoursite.com/ (optional)'),

            'skin'                  => array('select', 'News skin', $all_skins),
            'cn_language'           => array('select', 'News internationalization', $lng),
