...
{    
    ...
    if ($member_name) 
    {
        ...
        $echo .= '<span class="cn_comm_forget"><a href="#" class="button" onclick="forget_me(); return false;">'.i18n('Remember me').'</a></span>';
    }
    ...
    if ($name)
    {
        ...
        $echo .= ' <input type="hidden" name="isforgetme" value="" />';
        $echo .= ' <span class="cn_comm_forget"><a href="#" class="button" onclick="forget_me(); return false;">'.i18n('Sign out').'</a></span>';
    }
...
{
    $echo = '<input type="submit" value="'.cn_htmlspecialchars($t).'" class="big-button-blue"/>';

    if ((test('Mea')||test('Mes')) && intval(REQ('edit_id')))
    {
        $echo .= '<input type="submit" name="cm_edit_comment" value="Edit Comment" class="button"/>';
    }
